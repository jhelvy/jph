...
* `quarto_render_move()`: `quarto::quarto_render()`, but output file is moved to `output_dir`. Temporary solution for the issue discussed in [this thread](https://github.com/quarto-dev/quarto-cli/discussions/2171#discussioncomment-5099284).
