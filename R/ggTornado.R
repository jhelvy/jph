...
#' @param varName The data column identifying the variable being varied.
#' @param levelName The data column identifying the sensitivity case level (high or low, relative to the baseline).
#' @param valName The data column identifying the value of the variable being varied.
#' @param resultName The data column identifying the result of the output value at the varied variable value.
...
#' library(tidyverse)
#' plot = ggTornado(data = data, baseline=baseline, varName='var',
...
ggTornado = function(
    ...
    df = data[c(varName, levelName, valName, resultName)]
    colnames(df) = c('var', 'level', 'val', 'result')
