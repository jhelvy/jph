...
* `qrender()`: `quarto::quarto_render()`, but output file can move. Related to [this thread](https://github.com/quarto-dev/quarto-cli/discussions/2171#discussioncomment-5099284).
