...
* `quarto_render_pdf()`: `quarto::quarto_render()`, but specific to PDFs, and the output file can be in a different directory than the working directory. Solves the issue discussed in [this thread](https://github.com/quarto-dev/quarto-cli/discussions/2171#discussioncomment-5099284).
